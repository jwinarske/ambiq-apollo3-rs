#[doc = "Reader of register CMPRAUXA3"]
pub type R = crate::R<u32, super::CMPRAUXA3>;
#[doc = "Writer for register CMPRAUXA3"]
pub type W = crate::W<u32, super::CMPRAUXA3>;
#[doc = "Register CMPRAUXA3 `reset()`'s with value 0"]
impl crate::ResetValue for super::CMPRAUXA3 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `CMPR3A3`"]
pub type CMPR3A3_R = crate::R<u16, u16>;
#[doc = "Write proxy for field `CMPR3A3`"]
...
#[doc = "Reader of field `CMPR2A3`"]
pub type CMPR2A3_R = crate::R<u16, u16>;
#[doc = "Write proxy for field `CMPR2A3`"]
