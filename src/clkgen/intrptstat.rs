#[doc = "Reader of register INTRPTSTAT"]
pub type R = crate::R<u32, super::INTRPTSTAT>;
#[doc = "Writer for register INTRPTSTAT"]
pub type W = crate::W<u32, super::INTRPTSTAT>;
#[doc = "Register INTRPTSTAT `reset()`'s with value 0"]
impl crate::ResetValue for super::INTRPTSTAT {
    type Type = u32;
    #[inline(always)]
