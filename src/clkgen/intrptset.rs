#[doc = "Reader of register INTRPTSET"]
pub type R = crate::R<u32, super::INTRPTSET>;
#[doc = "Writer for register INTRPTSET"]
pub type W = crate::W<u32, super::INTRPTSET>;
#[doc = "Register INTRPTSET `reset()`'s with value 0"]
impl crate::ResetValue for super::INTRPTSET {
    type Type = u32;
    #[inline(always)]
