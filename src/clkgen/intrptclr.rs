#[doc = "Reader of register INTRPTCLR"]
pub type R = crate::R<u32, super::INTRPTCLR>;
#[doc = "Writer for register INTRPTCLR"]
pub type W = crate::W<u32, super::INTRPTCLR>;
#[doc = "Register INTRPTCLR `reset()`'s with value 0"]
impl crate::ResetValue for super::INTRPTCLR {
    type Type = u32;
    #[inline(always)]
