#[doc = "Reader of register DMADEVADDR"]
pub type R = crate::R<u32, super::DMADEVADDR>;
#[doc = "Writer for register DMADEVADDR"]
pub type W = crate::W<u32, super::DMADEVADDR>;
#[doc = "Register DMADEVADDR `reset()`'s with value 0"]
impl crate::ResetValue for super::DMADEVADDR {
    type Type = u32;
    #[inline(always)]
...
pub type DEVADDR_R = crate::R<u32, u32>;
